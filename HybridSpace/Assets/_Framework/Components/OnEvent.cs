...
public class OnEvent : MonoBehaviour
{
    ...
    [SerializeField]
    private ColliderEvent colliderEvent = new ColliderEvent();
    [SerializeField]
    private Collider2DEvent collider2DEvent = new Collider2DEvent();
    [SerializeField]
    private CollisionEvent collisionEvent = new CollisionEvent();
    [SerializeField]
    private Collision2DEvent collision2DEvent = new Collision2DEvent();
